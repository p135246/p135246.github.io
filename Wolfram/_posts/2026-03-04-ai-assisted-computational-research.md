...
For two years I used AI in a basic way—for chat, reformats, and corrections. Coming from a corporate environment, I was anxious about context sharing and correctness. The peak of my AI usage was taking advantage of most of [CodeCompanion][codecompanion]'s functionality for [Neovim][neovim], except agents.
