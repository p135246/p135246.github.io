...
Methods of that approach would include, for example, embedding trivalent graphs into a Riemannian manifold with sufficiently short edges, all of the same length, distributed proportionally to the volume; constructing approximate unit-length embeddings of graphs in Euclidean spaces; manifold learning; and computing invariants under coarse equivalence and deriving bounds on them in terms of discrete invariants.
